...
![Version: 0.28.0](https://img.shields.io/badge/Version-0.28.0-informational?style=flat)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat)
![AppVersion: 3.0.4](https://img.shields.io/badge/AppVersion-3.0.4-informational?style=flat)
...
| <https://charts.bitnami.com/bitnami> | mariadb | 26.2.0 |
| <https://charts.bitnami.com/bitnami> | postgresql | 18.8.1 |
...
Chart `0.28.0` updates Paperless-ngx to the stable `3.0.4` release.
...
| image.tag | string | `"3.0.4"` | Image tag |
